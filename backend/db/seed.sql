...
-- ----------------------------------------------------------------------------
-- Tax lots: Alice's 250-unit Vasca-SPV position, acquired in two lots (sums to
-- the holding's 250 units / 2500 cost basis) — the Tax Center's lot detail.
-- ----------------------------------------------------------------------------
INSERT INTO tax_lots (id, user_id, spv_id, acquired_on, units, cost_basis)
VALUES
  ('00000000-0000-0000-0000-0000000000f6','00000000-0000-0000-0000-000000000001',
   '00000000-0000-0000-0000-0000000000af','2025-05-15',150,1500.00),
